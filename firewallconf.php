...
<div class="div_saut_ligne">
  ...
  <table width="400" border="0">	
  		      ...
  		      <tr>
        <td ><h2  onMouseOver="mouseOver5()" onMouseOut="mouseOut5()">Firewall configuration </h2></td>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="python/firewallconfig/firewall/firewall.php">
                  <div align="center">
    <p>&nbsp;</p>
    <p>&nbsp;</p>
