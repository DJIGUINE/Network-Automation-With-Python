...
#       print ("<br><br>successful connection") 
        ...
        tn.write(b"no network 100.10.10.0 255.255.255.0\n")
        tn.write(b"no network 200.10.10.0 255.255.255.0\n")
        tn.write(b"exit\n")
        tn.write(b"exit\n")
        tn.write(b"sh run\n")
        tn.write(b"exit\n")
    ...
    #saveoutput.write (str(readoutput))
        ...
        saveoutput.write("\n")
        saveoutput.close
        print("<br><br> Eigrp  Routing  Configuration  Successfull Canceled!")
        print('~' * 79)
    except:
