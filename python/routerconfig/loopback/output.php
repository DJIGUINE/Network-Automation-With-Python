...
<div class="div_saut_ligne">
  ...
  <table width="400" border="0" align="center">	
  		      ...
  		      <tr>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="outputrouter10.10.10.1.php">
...
<div class="div_input_form">
						<input   name="valid_inscr" id="valid_inscr" class="input_form" value="10.10.10.1" type="submit"> </input>
                          ...
                          <td > <form id="inscription" name="inscription" method="POST" action="outputrouter50.50.50.2.php">
...
<div class="div_input_form">
						<input   name="valid_inscr" id="valid_inscr" class="input_form" value="50.50.50.2" type="submit"> </input>
         ...
         <tr>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="outputrouter191.168.1.1.php">
...
<div class="div_input_form">
						<input   name="valid_inscr" id="valid_inscr" class="input_form" value="191.168.1.1" type="submit"> </input>
                          ...
                          <td>
				  <form id="inscription" name="inscription" method="POST" action="../../../Routerconfig.php">
