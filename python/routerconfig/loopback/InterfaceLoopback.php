...
$user = "djigui";
$password ="djigui";
//$command = escapeshellcmd(" python C:/xampp/htdocs/project/multiVlan.py '$vlan' '$name' '$user' '$password'"); 
$output =shell_exec("python myrouters1.py $user $password ");
echo "<h3>.$output.</h3>";
...
?>
  ...
  <table width="400" border="0">	
  		      ...
  		      <tr>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="canceloopback.php">
...
<div class="div_input_form">
						<input   name="valid_inscr" id="valid_inscr" class="input_form" value="Cancel" type="submit"> </input>
             ...
             <td > <form id="inscription" name="inscription" method="POST" action="output.php">
...
<div class="div_input_form">
						<input   name="valid_inscr" id="valid_inscr" class="input_form" value="Output" type="submit"> </input>
