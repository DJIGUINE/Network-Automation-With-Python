...
$output =shell_exec("python vlan.py");
echo "<h3>.$output.</h3>";
...
?>
  ...
  <table width="400" border="0">	
        ...
        <td>
				  <form id="inscription" name="inscription" method="POST" action="cancelvlan.php">
                  <div align="center">
...
<div class="div_input_form">
               ...
               <td>
				  <form id="inscription" name="inscription" method="POST" action="../../../switchconf.php">
