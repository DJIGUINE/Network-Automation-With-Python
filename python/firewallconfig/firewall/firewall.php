...
$output =shell_exec("python firewall.py");
echo "<h3>.$output.</h3>";
...
?>
 ...
 <td > <form id="inscription" name="inscription" method="POST" action="cancelfirewall.php">
...
<div class="div_input_form">
        ...
        <td>
				  <form id="inscription" name="inscription" method="POST" action="../../../firewallconf.php">
