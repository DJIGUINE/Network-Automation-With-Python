...
<div class="div_saut_ligne">
  ...
  <table width="400" border="0">	
  		      ...
  		      <tr>
        <td height="29"><h2  onMouseOver="mouseOver4()" onMouseOut="mouseOut4()"> VLAN configuration on switches</h2></td>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="python/switchconfig/vlan/vlan.php">
                  <div align="center">
    <p>&nbsp;</p>
    <p>&nbsp;</p>
