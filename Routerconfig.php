...
<div class="div_saut_ligne">
	...
	<div style="width:800px;display:inline-block;" id="conteneur">
      ...
      <table  width="400" border="0">	
            ...
            <td height="29"><h2 onMouseOver="mouseOver1()" onMouseOut="mouseOut1()">Interface Loopback configuration</h2>
    
            </td>
            <td>
                      <form id="inscription" name="inscription" method="POST" action="python/routerconfig/loopback/InterfaceLoopback.php">
                      <div align="center">
        <p>&nbsp;</p>
        <p>&nbsp;</p>
    ...
    <div class="div_input_form">
           ...
           <td height="29"><h2  onMouseOver="mouseOver2()" onMouseOut="mouseOut2()" >IEGRP Configuration</h2>
            <h5 id="demo2"  >
            </h5>
            ...
            <td>
                      <form id="inscription" name="inscription" method="POST" action="python/routerconfig/IEGRP/IEGRP.php">
                      <div align="center">
        <p>&nbsp;</p>
        <p>&nbsp;</p>
    ...
    <div class="div_input_form">
            ...
            <td height="29"><h2 onMouseOver="mouseOver3()" onMouseOut="mouseOut3()">OSPF Configuration</h2>
    
            </td>
            <td>
                      <form id="inscription" name="inscription" method="POST" action="python/routerconfig/OSPF/OSPF.php">
                      <div align="center">
        <p>&nbsp;</p>
        <p>&nbsp;</p>
