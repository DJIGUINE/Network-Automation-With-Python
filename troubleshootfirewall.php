...
<title>Troubleshootfirewall</title>
...
<div class="div_saut_ligne">
  ...
  <table width="600" border="0">	
  		      ...
  		      <tr>
        <td height="29"><h2 onMouseOver="mouseOver22()" onMouseOut="mouseOut22()">  Firewall Conectivity</h2></td>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="python/troubleshootfirewall/firewallconnectivity/firewallconnectivity.php">
                  <div align="center">
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
<div class="div_input_form">
						<input   name="valid_inscr" id="valid_inscr" class="input_form" value="Execute" type="submit"> </input>
                            ...
                            <td height="29"><h2 onMouseOver="mouseOver23()" onMouseOut="mouseOut23()">Show CPU Usage</h2></td>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="python/troubleshootfirewall/shcpuusage/shcpuusage.php">
                  <div align="center">
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
<div class="div_input_form">
                    ...
                    <tr>
        <td height="29"><h2 onMouseOver="mouseOver24()" onMouseOut="mouseOut24()">Show History</h2></td>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="python/troubleshootfirewall/shistory/shistory.php">
                  <div align="center">
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
<div class="div_input_form">
                    ...
                    <td height="29"><h2 onMouseOver="mouseOver25()" onMouseOut="mouseOut25()">Show  Route </h2></td>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="python/troubleshootfirewall/shroute/showroute.php">
                  <div align="center">
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
<div class="div_input_form">
              ...
              <tr>
        <td height="29"><h2 onMouseOver="mouseOver26()" onMouseOut="mouseOut26()">Show Connection All </h2></td>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="python/troubleshootfirewall/shconnall/shconnall.php">
                  <div align="center">
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
<div class="div_input_form">
						<input   name="valid_inscr" id="valid_inscr" class="input_form" value="Execute" type="submit"> </input>
                            ...
                            <td height="29"><h2 onMouseOver="mouseOver27()" onMouseOut="mouseOut27()">Show Disk</h2> </td>
        <td>
				  <form id="inscription" name="inscription" method="POST" action="python/troubleshootfirewall/shdisk/shdisk.php">
                  <div align="center">
    <p>&nbsp;</p>
    <p>&nbsp;</p>
